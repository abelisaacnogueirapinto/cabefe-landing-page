<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ManutencaoUregi.aspx.cs" Inherits="PortalCabefe.ManutencaoUregi" %>
			...
			<div class="container-fluid" id="OpcaoMenuPrincipal">
				<div class="row">
					...
					<div class="col-sm-8 container" id="conteudo2">
						<div id="topo">
							<h2 class="page-header">Manutençao - Uregi</h2>
						</div>
						<br/>
						<form role="form" class="form-horizontal" runat="server">
							<div class="form-group">
								<label class="control-label col-xs-3" for="inputLogin">Matrcula*</label>
								<div class="col-xs-3">
							...
							<br/>
							<div class="form-group">
								<label class="control-label col-xs-3" for="inputLogin">Uregi</label>
								<div class="col-xs-6">
									<asp:DropDownList class="form-control" ID="cmbUregi" runat="server" EnableTheming="True" style="width:100%">
									</asp:DropDownList>
								</div>
							</div>
							<br/>
