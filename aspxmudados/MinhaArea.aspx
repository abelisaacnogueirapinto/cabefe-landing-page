<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MinhaArea.aspx.cs" Inherits="PortalCabefe.MinhaArea" %>
	...
	<head>
		...
		<style>
		   ...
		   .MensPrincipal
			...
			#AdicionarUregi #AdicionarEndereco #AdicionarTelefone #AdicionarEmail #divUregi #divEndereco #divTelefone #divEmail
			{
				color: var(--corbranca);
			}
		...
		<main class="MainPrincipal">
				...
				<div class="container-fluid" id="OpcaoMenuPrincipal">
					<div class="row">
						...
						<div class="col-sm-9 container" id="conteudo2">
							<div id="topo">
								<h2>Minha Área</h2>
							</div>
							...
							<br/>
							<div id="dados">
								<div class="col-sm-8"><h4>Uregi:</h4></div>
								<div class="col-sm-3" id="AdicionaUregi" runat="server" visible="false"><br /><a href="ManutencaoUregi.aspx"  title="Clique para adicionar o Endereço">Adicionar novo</a></div>
								<div id="divUregi" runat="server"></div>
								<br />
								<div class="col-sm-8"><h4>Endereço:</h4></div>
								<div class="col-sm-3"  id="AdicionaEndereco" runat="server" visible="false"><br /><a href="ManutencaoEndereco.aspx?idx=-1"  title="Clique para adicionar o Endereço">Adicionar novo</a></div>
								<div id="divEndereco" runat="server"></div>
								<br />
								<div class="col-sm-8"><h4>Telefone:</h4></div>
								<div class="col-sm-3" id="AdicionaTelefone" runat="server" visible="false"><br /><a href="ManutencaoTelefone.aspx?idx=-1"  title="Clique para adicionar o Telefone">Adicionar novo</a></div>
								<div id="divTelefone" runat="server"></div>
								<br />
								<div class="col-sm-8"><h4>Email:</h4></div>
								<div class="col-sm-3" id="AdicionaEmail" runat="server" visible="false"><br /><a href="ManutencaoEmail.aspx?idx=-1"  title="Clique para adicionar o Email">Adicionar novo</a></div>
								<div id="divEmail" runat="server"></div>
								<br />
							</div>
						</div>
					</div>
