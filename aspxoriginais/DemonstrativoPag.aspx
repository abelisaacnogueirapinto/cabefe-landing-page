<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="DemonstrativoPag.aspx.cs" Inherits="PortalCabefe.DemonstrativoPag" %>
	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h1 class="page-header">Demonstrativo de Pagamento do Associado</h1>
				</div>
				<br/>
			    <form role="form" class="form-horizontal" runat="server">
				    ...
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Competência*</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtCompetencia" runat="server" onkeyup="formataMesAno(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
