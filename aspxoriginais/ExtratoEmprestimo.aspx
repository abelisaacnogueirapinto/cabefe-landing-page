<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ExtratoEmprestimo.aspx.cs" Inherits="PortalCabefe.ExtratoEmprestimo" %>
	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h1 class="page-header">Extratos de Empréstimos Contraídos</h1>
				</div>
				<br/>
			    <form role="form" class="form-horizontal" runat="server">
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-xs-3">
                            ...
                            <%--<asp:TextBox class="form-control" ID="txtFundo" runat="server" onkeyup="formataInteiro(this,event);" style="text-align:right"></asp:TextBox>--%>
					    </div>
				    </div>
				    <%--//SAC - 62273 - Chitão
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Empréstimo</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtEmprestimo" runat="server" onkeyup="formataInteiro(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    //SAC - 62273 - Chitão--%>
				    <%--//SAC - 62273 - Chitão
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Data Inicial da Solicitação</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtDataInicialSolicitacao" runat="server" onkeyup="formataData(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Data Final da Solicitação</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtDataFinalSolicitacao" runat="server" onkeyup="formataData(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    //SAC - 62273 - Chitão--%>
				    <br/>
				    ...
				    <div class="form-group">
					    <div class="col-xs-offset-3 col-xs-3">
					    <!--<button class="btn btn-lg btn-primary btn-block botao" style="max-width:180px;" type="button" id="botao" onclick="confirmaLogin()">Entrar</button>-->
