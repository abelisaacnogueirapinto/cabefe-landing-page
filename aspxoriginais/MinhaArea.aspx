	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h2 class="page-header">Minha Área</h2>
				</div>
				<br/>
				<div id="dados">
				    <div class="col-sm-8"><h4 class="page-header">Uregi:</h4></div><div class="col-sm-3" id="AdicionaUregi" runat="server" visible="false"><br /><a href="ManutencaoUregi.aspx"  title="Clique para adicionar o Endereço">Adicionar novo</a></div>
				    <div id="divUregi" runat="server">
				    </div>
				    <br />
				    <div class="col-sm-8"><h4 class="page-header">Endereço:</h4></div><div class="col-sm-3" id="AdicionaEndereco" runat="server" visible="false"><br /><a href="ManutencaoEndereco.aspx?idx=-1"  title="Clique para adicionar o Endereço">Adicionar novo</a></div>
				    <div id="divEndereco" runat="server">
				    </div>
				    <br />
				    <div class="col-sm-8"><h4 class="page-header">Telefone:</h4></div><div class="col-sm-3" id="AdicionaTelefone" runat="server" visible="false"><br /><a href="ManutencaoTelefone.aspx?idx=-1"  title="Clique para adicionar o Telefone">Adicionar novo</a></div>
				    <div id="divTelefone" runat="server">
				    </div>
				    <br />
				    <div class="col-sm-8"><h4 class="page-header">Email:</h4></div><div class="col-sm-3" id="AdicionaEmail" runat="server" visible="false"><br /><a href="ManutencaoEmail.aspx?idx=-1"  title="Clique para adicionar o Email">Adicionar novo</a></div>
