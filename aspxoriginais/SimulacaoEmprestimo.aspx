<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SimulacaoEmprestimo.aspx.cs" Inherits="PortalCabefe.SimulacaoEmprestimo" %>
	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
				...
				<nav class="collapse navbar-collapse" style="margin:0; padding:0;">
					<div style="padding:0;">
						<ul class="nav navbar-custom" id="menuUsuario" style="display:list-item">								
							...
							<li class="btnMenuUsuario"><asp:HyperLink ID="download" runat="server" NavigateUrl="~/DownloadDocumentos.aspx" text="Download e informações" OnClick="download_Click" ></asp:HyperLink></li>
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h3 class="page-header">Simulação de Empréstimo</h3>
				</div>
				
			    <div class="form-group">
				<font size="2"><FONT FACE=Arial COLOR="#AA0000"> <p>&nbsp&nbsp Empréstimo nos fundos I e II só poderão ser solicitados após o pagamento de 2/3 do último empréstimo <br> &nbsp&nbsp contraído.</p><p> &nbsp&nbsp-  Fundo II , o saldo devedor deverá ser pago mediante depósito em conta bancária do referido fundo e <br>&nbsp&nbsp envio de comprovante da quitação à CABEFE.</P><P>&nbsp - Fundo I, saldo devedor poderá ser deduzido do valor do novo empréstimo.</p></font>
                           </div>
			    ...
			    <form role="form" class="form-horizontal" runat="server">
				    ...
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Fundo*</label>
					    <div class="col-xs-3">
                            <asp:DropDownList ID="DropDownList1" runat="server">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem Value="1">1 - Fundo Simples I</asp:ListItem>
                                <asp:ListItem Value="2">2 - Fundo Simples II</asp:ListItem>
                            </asp:DropDownList>
					    </div>
				    </div>
				    <br/>
				    ...
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Salário Líquido*</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtSalarioLiquido" runat="server" onkeyup="formataValor(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Valor do Empréstimo*</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtValorEmprestimo" runat="server" onkeyup="formataValor(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>

				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Número de Parcelas*</label>
					    <div class="col-xs-3">
						    <asp:TextBox class="form-control" ID="txtNumeroParcelas" runat="server" onkeyup="formataInteiro(this,event);" style="text-align:right"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
				    ...
				    <div class="form-group">
					    <div class="col-xs-offset-3 col-xs-3">
					        <asp:Button class="btn btn-lg btn-primary btn-block botao" ID="botao" runat="server" Text="Gerar" OnClick="botao_Click" /><br/>
					        <%--<asp:Button class="btn btn-lg btn-primary btn-block botaoVoltar" ID="botaoVoltar" runat="server" Text="Voltar" OnClick="voltar_Click" /><br/>--%>
				        </div>
				    </div>
			    </form>
			</div>
		...
		<footer>
			<div class="row" id="rodape">
				...
				<div class="col-sm-4" style="margin-right:-15px;">
					<p style="margin-bottom:0">Telefones:(31)3349-8165 - Ger&ecirc;ncia</p>
