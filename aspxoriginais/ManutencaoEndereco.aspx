<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ManutencaoEndereco.aspx.cs" Inherits="PortalCabefe.ManutencaoEndereco" %>
	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h2 class="page-header">Manutenção - Endereço</h2>
				</div>
				<br/>
			    <form role="form" class="form-horizontal" runat="server">
				    ...
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Logradouro</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtLogradouro" runat="server"  style="text-align:left; width:100%"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    ...
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtNumero" runat="server"  style="text-align:left; width:100px" MaxLength="7"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Complemento</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtCompl" runat="server"  style="text-align:left; width:100%"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Bairro</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtBairro" runat="server"  style="text-align:left; width:100%" MaxLength="200"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Estado</label>
					    <div class="col-xs-6">
                            <asp:DropDownList class="form-control" ID="cmbUF" runat="server" EnableTheming="True" style="width:50%" OnSelectedIndexChanged="cmbUF_SelectedIndexChanged" CausesValidation="true" AutoPostBack="true">
                            </asp:DropDownList>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Cidade</label>
					    <div class="col-xs-6">
                            <asp:DropDownList class="form-control" ID="cmbCidade" runat="server" EnableTheming="True" style="width:100%">
                            </asp:DropDownList>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">CEP</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtCEP" runat="server"  style="text-align:left; width:120px" MaxLength="9" onchange="formataCEP(this,event);" onkeyup="formataCEP(this,event);"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Ponto de Referência</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtRef" runat="server"  style="text-align:left; width:100%" MaxLength="200"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
