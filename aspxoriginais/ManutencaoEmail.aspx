<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ManutencaoEmail.aspx.cs" Inherits="PortalCabefe.ManutencaoEmail" %>
	...
	<body onload= "Load()">
		...
		<div class="row" style="min-height:400px; max-width:1080px; margin:auto;">
			...
			<div class="col-sm-8 container" id="conteudo2">
				<div id="topo">
					<h2 class="page-header">Manutenção - Email</h2>
				</div>
				<br/>
			    <form role="form" class="form-horizontal" runat="server">
				    ...
				    <br/>
				    <div class="form-group">
					    <label class="control-label col-xs-3" for="inputLogin">Email</label>
					    <div class="col-xs-6">
						    <asp:TextBox class="form-control" ID="txtEmail" runat="server"  style="text-align:left"></asp:TextBox>
					    </div>
				    </div>
				    <br/>
				    <div class="form-group">
